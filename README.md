...
La aplicación utiliza el patrón **MVVM (Model-View-ViewModel)** para separar la interfaz, la lógica de presentación y el acceso a los servicios en la nube.
...
flowchart TB
    ...
    subgraph VM["ViewModel"]
        VIEWMODEL["Estado UI y logica de presentacion"]
    end
    ...
    VIEW -->|eventos de usuario| VIEWMODEL
    VIEWMODEL -->|estado de la interfaz| VIEW
    VIEWMODEL -->|solicita datos| REPOSITORY
    REPOSITORY -->|registro e inicio de sesion| AUTH
    REPOSITORY -->|lectura y escritura de historias| FIRESTORE
...
El flujo es: la **View** recibe la interacción del usuario; el **ViewModel** procesa el evento y actualiza el estado de la interfaz; el **Repository** concentra el acceso a Firebase Authentication y Cloud Firestore.
